...
public class Backloanbook extends AsyncTask<String, String, String> {
    Context context;
    static   String retx="";
    Backloanbook(Context ctx,String sa) {
        this.context = ctx;
        this.retx = sa;
    }
            ...
            try {
                ...
                try {
                    ...
                    String insert_data = URLEncoder.encode("email", "UTF-8") + "=" + URLEncoder.encode(email, "UTF-8") +
                            ...
                            "&" + URLEncoder.encode("bookstatus", "UTF-8") + "=" + URLEncoder.encode(bookstatus, "UTF-8") +
                            "&" + URLEncoder.encode("loantime", "UTF-8") + "=" + URLEncoder.encode(loantime, "UTF-8") ;
